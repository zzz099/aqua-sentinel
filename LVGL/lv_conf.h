...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_SIZE (8U * 1024U * 1024U) /* 8MB SDRAM */

    /*Set an address for the memory pool instead of allocating it as a normal array. Can be in external SRAM too.*/
    #define LV_MEM_ADR 0xC0400000 /* 4MB offset in SDRAM *//*0: unused*/
...
#define LV_DISP_DEF_REFR_PERIOD 16      /*[ms], match ~60 Hz panel refresh*/

/*Input device read period in milliseconds*/
#define LV_INDEV_DEF_READ_PERIOD 10     /*[ms], reduce fast-swipe point loss*/
